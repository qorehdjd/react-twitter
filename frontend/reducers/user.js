...
export const initialState = {
  ...
  loadUserInfoLoading: false, // 상대방 정보 가져오기 시도중
  ...
  unfollowDone: false,
  unfollowError: null,
  removeFollowerLoading: false, // 팔로우제거 시도중,
  removeFollowerDone: false,
  removeFollowerError: false,
  loadFollowersLoading: false, // 팔로우가져오기 시도중
  loadFollowersDone: false,
  loadFollowersError: false,
  loadFollowingsLoading: false, // 팔로잉가져오기 시도중
...
const reducer = (state = initialState, action) => produce(state, (draft) => {
  switch (action.type) {
    ...
    case FOLLOW_SUCCESS:
      ...
      draft.me.Followings.push({ nickname: action.data.nickname });
      break;
    case FOLLOW_FAILURE:
      draft.followLoading = false;
    ...
    case UNFOLLOW_SUCCESS: {
      ...
      // draft.me.Followings = draft.me.Followings.filter((v) => v.nickname !== action.data);
      break;
    }
